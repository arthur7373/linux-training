...
> * you have local DNS server, which contains properly configured zone `lt01.am` 
 with A records `lt01.am` & `www.lt01.am` pointing to your server's IP address
> * and your `/etc/resolv.conf` refers to `nameserver 127.0.0.1`)


efault website location directory is:  `/var/www/html` 
